export const Endpoints = {
  ...
  AGGREGATES_GLOBAL_CHARACTER_SINGLE: '/aggregates/global/character/{character}',
  ...
  AGGREGATES_GLOBAL_VEHICLE_CHARACTER_SINGLE: '/aggregates/global/vehicle/character/{character}',
  AGGREGATES_GLOBAL_VEHICLE_CHARACTER_SINGLE_VEHICLE: '/aggregates/global/vehicle/character/{character}/{vehicle}',
  ...
  AGGREGATES_INSTANCE_CHARACTER_SINGLE: '/aggregates/instance/{instance}/character/{character}',
  AGGREGATES_INSTANCE_FACILITY: '/aggregates/instance/{instance}/facility',
  AGGREGATES_INSTANCE_FACILITY_SINGLE: '/aggregates/instance/{instance}/facility/{facility}',
  ...
  AGGREGATES_INSTANCE_LOADOUT_SINGLE: '/aggregates/instance/{instance}/loadout/{loadout}',
  AGGREGATES_INSTANCE_OUTFIT: '/aggregates/instance/{instance}/outfit',
  AGGREGATES_INSTANCE_OUTFIT_SINGLE: '/aggregates/instance/{instance}/outfit/{outfit}',
  ...
  AGGREGATES_INSTANCE_VEHICLE_SINGLE: '/aggregates/instance/{instance}/vehicle/{vehicle}',
