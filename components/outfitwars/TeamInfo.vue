  ...
  <div class="card flex flex-col" :class="backgroundClass">
    ...
    <div
      v-if="
        !(
          alert.outfitwars &&
          alert.outfitwars.teams &&
          alert.outfitwars.teams.red &&
          alert.outfitwars.teams.blue
        )
      "
    ...
    <div v-else class="flex relative justify-between items-center flex-1">
      <div
        ...
        :class="factionBackground(alert.outfitwars.teams.red.faction)"
      >
        <img
          class="w-4/5 m-auto"
      ...
      <TeamLogo
        ...
        :outfit-id="alert.outfitwars.teams.red.id"
        :outfit-faction="alert.outfitwars.teams.red.faction"
      ...
      <div class="relative place-self-stretch grow">
        ...
        >
          ...
          <div
            class="text-xs label"
            :class="alert.outfitwars.teams.red.faction | factionShortName"
          >
        ...
        >
          <div
            class="text-xs label"
            :class="alert.outfitwars.teams.blue.faction | factionShortName"
          >
      ...
      <TeamLogo
        class="self-center place-self-center w-12 lg:w-24 2xl:w-32"
        :outfit-id="alert.outfitwars.teams.blue.id"
        :outfit-faction="alert.outfitwars.teams.blue.faction"
        :badge-left="true"
        :loser="alert.result && alert.result.victor === 3"
      />
      <div
        class="absolute -right-4 -bottom-4 w-4 md:w-6 xl:w-8 2xl:w-10 rounded"
        :class="factionBackground(alert.outfitwars.teams.blue.faction)"
      >
        <img
          class="w-4/5 m-auto"
