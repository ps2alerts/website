  ...
  <div class="card flex flex-col">
    ...
    >
      <div class="self-center place-self-center">
        <object
          :data="alert.outfitwars.teams.red.id | outfitImage"
          type="image/png"
          width="125px"
        >
          <img
      ...
      <div class="grid grid-cols-7 gap-2 justify-center grow">
        <div class="col-start-1 col-span-3 align-bottom text-right text-xl mb-2 lg:mb-0">
        ...
        <div class="col-end-8 col-span-3 align-bottom text-left text-xl mb-2 lg:mb-0">
      ...
      <div class="self-center place-self-center">
        <object
          :data="alert.outfitwars.teams.blue.id | outfitImage"
          type="image/png"
          width="125px"
        >
          <img
