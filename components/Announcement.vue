<template>
  ...
  >
    ...
    <div>
      ...
      <p>
        This will not be fixed until Census has been changed. I'm also not willing to "bodge" a fix by attempting to calculate which faction NSO are playing on as it is inherently inaccurate as Freelance NSO can bounce between factions at will, and it will consume a lot of my limited time even attempting it when the game should supply it. When the NSO hype peters out, this issue will naturally dissipate.
      </p>
      <p>
