...
import { InstanceFacilityControlEntriesResponseInterface } from '~/interfaces/aggregates/entries/InstanceFacilityControlEntriesResponseInterface'
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      data: {} as InstanceFacilityControlEntriesResponseInterface[],
    }
  },
  computed: {
  ...
  methods: {
    ...
    transformData(
      ...
      const newData: InstanceFacilityControlEntriesResponseInterface[] = []
