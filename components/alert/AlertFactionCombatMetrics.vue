    ...
    <div v-if="loaded">
      <table class="w-full table-auto text-center">
        <thead>
          <tr>
            <td>Metric</td>
            <td class="bg-vs">VS</td>
            <td class="bg-tr">TR</td>
            <td class="bg-nc">NC</td>
            <td class="bg-nso">>NSO</td>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>Kills</td>
            <td>{{ data.vs.kills || 0 }}</td>
            <td>{{ data.tr.kills || 0 }}</td>
            <td>{{ data.nc.kills || 0 }}</td>
            <td>{{ data.nso.kills || 0 }}</td>
          </tr>
        </tbody>
      </table>
